  ...
  return [
    ...
    },
    {
      ...
      cards: [
        ...
        { label: 'Cacho mal posicionado', value: formatNumber(totals.corteCachoMalPosicionado), detail: `${formatPercent(safePct(totals.corteCachoMalPosicionado, basePlantas))} das plantas`, tone: 'warning' },
        { label: 'Palha mal empilhada', value: formatNumber(totals.cortePalhaMalEmpilhada), detail: `${formatPercent(safePct(totals.cortePalhaMalEmpilhada, basePlantas))} das plantas`, tone: 'warning' },
